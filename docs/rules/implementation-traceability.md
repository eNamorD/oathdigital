...
| Edifices are denizens; ruined edifices do not block Trade/Muster | **Tested (bounded)** | [NF p. 16](new-foundations-delta.md#empire-and-other-changes); normative CR pp. 24, 31 | `EdificeState` shares the Economy target path and ruined edifices do not introduce active powers. Intact modifier-bearing edifices remain outside the unaltered first-game boundary. | Intact edifice Economy handlers remain B5. |
